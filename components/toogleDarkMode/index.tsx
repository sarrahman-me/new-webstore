  ...
  return (
    <div>
      <button
        ...
        className="flex items-center border-2 gap-2 p-2 rounded-lg transition-colors duration-300 focus:outline-none focus:ring-1 border-slate-500 bg-slate-50 dark:bg-slate-700"
      >
        <span
